#+STARTUP: overview
#+TITLE: Uncle Dave's Emacs With Higanbana's Modification
...
* Vim Mode
Who the hell use emacs keybinding for basic movements!
#+BEGIN_SRC emacs-lisp
  (use-package evil
    :ensure t
    :init
...
** Spaceline!
I may not use spacemacs, since spacemacs incredibly bloated and slow,
